$(document).ready(function () {
	...
	function addCrystal() {
		...
		if (userNumber === randoNumber) {
			document.querySelector(".modal-title").textContent = "Crystal Collector";
			document.querySelector(".modal-body").textContent = "Congratulations! You Won!";
			totalWins++;
		} else {
			document.querySelector(".modal-title").textContent = "Crystal Collector";
			document.querySelector(".modal-body").textContent = "Oh no! You've gone over. You'll need the exact combination to win.";
			totalLosses++;
		}
